...
document.querySelectorAll('#nazwa_zamowienia_text, #podstawa_ust_wartosci_text, #zalaczniki_text, #kwota_przeznaczona_zrodlo_text,'
...
document.getElementById('download').addEventListener('click', async () => {
    ...
    document.getElementById('dodatkowe_cpv').value = document.getElementById('dodatkowe_cpv_text').innerText;
    document.getElementById('plan_zamowien_oznaczenia').value = document.getElementById('plan_zamowien_oznaczenia_text').innerText;
    document.getElementById('plan_zamowien_wartosci').value = document.getElementById('plan_zamowien_wartosci_text').innerText;
    document.getElementById('zamowienie_pzp_kwota').value = document.getElementById('zamowienie_pzp_kwota_text').innerText;
    document.getElementById('podstawa_ust_wartosci').value = document.getElementById('podstawa_ust_wartosci_text').innerText;
    document.getElementById('kwota_przeznaczona_zrodlo').value = document.getElementById('kwota_przeznaczona_zrodlo_text').innerText;
    document.getElementById('termin_wykonania').value = document.getElementById('termin_wykonania_text').innerText;
    document.getElementById('informacje_dodatkowe').value = document.getElementById('informacje_dodatkowe_text').innerText;
    document.getElementById('zalaczniki').value = document.getElementById('zalaczniki_text').innerText;
